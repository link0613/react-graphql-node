...
class SearchActivePodComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderSidebar = () => {
    ...
    return (
      <QueryRenderer
        ...
        query={
          graphql`
            query SearchActive_indicator_Query($scriptID: String!) {
  ...
  render() {
    ...
    return (
      <Page
        title='Enterprise Search: Active Searches'
...
export default createFragmentContainer(
  SearchActivePodComponent,
  graphql`
    fragment SearchActive_entitiesList on Search @relay(plural: true) {
      id
      _id
      __typename
      state
