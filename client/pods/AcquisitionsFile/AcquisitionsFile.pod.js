...
class AcquisitionsFilePodComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderSidebar = () => {
    ...
    return (
      <QueryRenderer
        ...
        query={
          graphql`
            query AcquisitionsFile_indicator_Query($scriptID: String!) {
...
export default createFragmentContainer(
  AcquisitionsFilePodComponent,
  graphql`
    fragment AcquisitionsFile_entitiesList on Script @relay(plural: true) {
      id
      _id
      last_used_at
      url
