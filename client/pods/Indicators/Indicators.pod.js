...
class IndicatorsPodComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderSidebar = () => {
    ...
    return (
      <QueryRenderer
        ...
        query={
          graphql`
            query Indicators_indicator_Query($scriptID: String!) {
...
export default createFragmentContainer(
  IndicatorsPodComponent,
  graphql`
    fragment Indicators_entitiesList on Script @relay(plural: true) {
      id
      _id
      last_used_at
      url
