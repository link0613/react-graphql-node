...
class AcquisitionsPodComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderSidebar = () => {
    ...
    return (
      <QueryRenderer
        ...
        query={
          graphql`
            query Acquisitions_indicator_Query($scriptID: String!) {
...
export default createFragmentContainer(
  AcquisitionsPodComponent,
  graphql`
    fragment Acquisitions_entitiesList on Script @relay(plural: true) {
      id
      _id
      last_used_at
      url
